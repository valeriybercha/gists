...
* [Install Fidler for Windows](https://github.com/valeriybercha/gists/blob/master/software-qa/install-fiddler-desktop.md)
* [Install Java on Windows](https://github.com/valeriybercha/gists/blob/master/software-qa/installing_java.md)
* [First application in Java](https://github.com/valeriybercha/gists/blob/master/software-qa/first_program_in_java.md)
* [Install and setup Intellij Idea for Windows](https://github.com/valeriybercha/gists/blob/master/software-qa/install-java-intellij-idea.md)
...
* [Windows 10 setup process](https://github.com/valeriybercha/gists/blob/master/windows-10-setup.md)
* [Windows Command Prompt cheatsheet](https://github.com/valeriybercha/gists/blob/master/command-shell/basic-cmd-commands.md)
